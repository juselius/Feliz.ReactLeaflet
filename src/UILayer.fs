...
type marker =
    ...
    static member inline icon (value: Leaflet.Icon<obj>) = Interop.mkMarkerProp "icon" value
    static member inline icon (value: Leaflet.DivIcon) = Interop.mkMarkerProp "icon" value
    static member inline opacity (value: float) = Interop.mkMarkerProp "opacity" value
    static member inline position (value: LatLng) = Interop.mkMarkerProp "position" value
    static member inline position (value: LatLngAlt) = Interop.mkMarkerProp "position" value
...
type popup =
    ...
    static member inline position (value: LatLng) = Interop.mkPopupProp "position" value
    static member inline position (value: LatLngAlt) = Interop.mkPopupProp "position" value
    static member inline offset (value: Point) = Interop.mkPopupProp "offset" value
    ...
    static member inline autoPanPaddingTopLeft (value: Point) = Interop.mkPopupProp "autoPanPaddingTopLeft" value
    static member inline autoPanPaddingBottomRight (value: Point) = Interop.mkPopupProp "autoPanPaddingBottomRight" value
    static member inline autoPanPadding (value: Point) = Interop.mkPopupProp "autoPanPadding" value
...
type tooltip =
    ...
    static member inline position (value: LatLng) = Interop.mkTooltipProp "position" value
    static member inline position (value: LatLngAlt) = Interop.mkTooltipProp "position" value
    static member inline offset (value: Point) = Interop.mkTooltipProp "offset" value
