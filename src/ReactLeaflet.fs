...
type mapContainer =
    ...
    static member inline style (value: IStyleAttribute list) = Interop.mkMapContainerProp "style" value
    ...
    static member inline ref (value: (obj -> unit)) = Interop.mkMapContainerProp "ref" value
    static member inline key (value: string) = Interop.mkMapContainerProp "key" value
    static member inline custom (key: string, value: obj) = Interop.mkMapContainerProp key value
